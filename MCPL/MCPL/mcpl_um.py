...
def load_clip_to_cpu():
    ...
    design_details = {"trainer": 'MaPLe', "vision_depth": 0, "language_depth": 0, "vision_ctx": 0, "language_ctx": 0, "maple_length": 2*1}
    # design_details = {"trainer": 'MaPLe', "vision_depth": 0, "language_depth": 0, "vision_ctx": 0, "language_ctx": 0, "maple_length": 2*7}
...
class MultiModalPromptLearner(nn.Module):
    ...
    def forward(self, batch):
        ...
        prefix = texts[:, :1, :]
        suffix = texts[:, 5:77, :]
        texts = torch.cat([prefix, ctx_text, suffix], dim=1) #中间夹了4个prompt
