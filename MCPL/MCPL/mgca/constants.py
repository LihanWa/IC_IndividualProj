...
MIMIC_CXR_DATA_DIR = '/rds/general/user/lw1824/home/chex/chex/dataset/MIMIC-CXR/mimic-cxr-jpg_2-0-0'
...
MIMIC_CXR_VALID_CSV = os.path.join(MIMIC_CXR_DATA_DIR, "valid.csv")
