...
def load_model_from_checkpoint(ckpt_dict: dict, config):
    log.info(f'Loading model from checkpoint: {ckpt_dict}')
    ...
    model = instantiate_model(config_dict, config_override=None, from_checkpoint=True)
