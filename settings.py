...
CHEX_DIR = os.environ.get('CHEX_DIR')

THIRD_PARTY_MODELS_DIR = os.environ.get('THIRD_PARTY_MODELS', os.path.join(CHEX_DIR,"chex/chex/models/third_party"))
SRC_DIR = os.path.dirname(os.path.realpath(__file__))
PROJECT_DIR = os.path.dirname(SRC_DIR)

DATA_DIR =os.path.join(CHEX_DIR,'chex/chex/dataset')
